...
<section class="bg-white text-gray-800">
  ...
  `}function N(){return setTimeout(()=>{const e=document.getElementById("toggle-register"),s=document.getElementById("register-container");let n=!1;e?.addEventListener("click",()=>{n=!n,s.classList.toggle("max-h-0",!n),s.classList.toggle("max-h-screen",n)})},0),`
